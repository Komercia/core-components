  ...
  <footer class="footer">
    <div class="footer-container-icons">
      <a
        ...
        target="_blank"
        class="footer-icon"
      ><i class="icon icon-instagrem"></i></a>
      <a
    ...
    <nav class="container-menu-footer-list">
      <ul class="menu-footer-list">
        <li
          v-for='(item, index) in routesFooter'
    ...
    <div class="footer_powered_by">
      <img src="https://res.cloudinary.com/komercia-store/image/upload/v1536181546/komercia/icon.png">
