  ...
  <div class="description">
    ...
    <div class="right" :class="{'stage': activeClass }">
      ...
      <div class="deliverys section">
        ...
        <div v-if="envios.valores.envio_metodo === 'precio_ciudad' && data.detalle.envio_gratis == 0" class="wrapper-method">
        ...
        <div v-if="envios.valores.envio_metodo === 'tarifa_plana' && data.detalle.envio_gratis == 0" class="wrapper-method">
        ...
        <div v-if="envios.valores.envio_metodo === 'precio' && data.detalle.envio_gratis == 0" class="wrapper-method">
          <h4>Precio por Total de Compra</h4>
          <p class="description-method">El valor del envío se calcula de acuerdo al total de compra</p>
        </div>
        <div v-if="envios.valores.envio_metodo === 'gratis' || data.detalle.envio_gratis == 1" class="wrapper-method">
          <h4>Gratis</h4>
