  ...
  <div class="modal">
    <div class="modal_content">
      <div class="modal_content_header">
        ...
        <i id="closeModal" v-on:click="togglePayment" class="material-icons close">close</i>
      </div>
      <div class="modal_content_list">
        <div class="modal_content_item" v-if="mediospago.payco">
        ...
        <div class="modal_content_item" v-if="mediospago.convenir">
        ...
        <div class="modal_content_item" v-if="mediospago.tienda">
