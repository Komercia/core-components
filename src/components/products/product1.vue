      ...
      <div class="section">
        ...
        <div class="features">
          <div class="features_item">
            <img
              src="https://res.cloudinary.com/komercia-store/image/upload/v1536696054/komercia/cards.png"
              alt
            >
          ...
          >
            <img
              src="https://res.cloudinary.com/komercia-store/image/upload/v1536696043/komercia/mensajero.png"
              alt
            >
            <div class="features_item_info">
              <h3>{{ envio.titulo }}</h3>
